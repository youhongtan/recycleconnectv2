...
import { Leaf, LayoutDashboard, Users, MapPin, QrCode, Mail, UserCheck, ArrowLeft, ShieldAlert, Loader2, School, Gift } from "lucide-react";
...
const NAV = [
  ...
  { to: "/admin/rewards", key: "rewards", icon: Gift },
  { to: "/admin/school-requests", key: "schoolRequests", icon: School },
